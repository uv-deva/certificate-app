...
const Wallets = () => {
  ...
  const onTableFilter = filter => {
    dispatch(ontTableDataFilter('wallets', filter))
  }
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle={<Badge style={{background:'#6610f2', color:'white'}}>{intl.formatMessage({id:"Wallets"})}</Badge>} breadCrumbParent='Web3 - Services' breadCrumbActive='Wallets' />
      <Row>
        <Col sm='12'>
          <TableWithButtons
